...
INSERT INTO customer (phonenumber, username, password, profile, creationdate) VALUES
('0145746078', 'admin', '12345', 1, now());
...
CREATE TABLE `booking` (
  `bookingcount` int NOT NULL AUTO_INCREMENT,
  `phonenumber` varchar(32) NOT NULL,
  `appointmentdate` datetime NOT NULL,
  `creationdate` datetime NOT NULL,
  PRIMARY KEY (bookingcount)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
